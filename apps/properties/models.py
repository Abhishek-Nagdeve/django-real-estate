...
class Property(TimeStampedUUIDModel):
    ...
    pincode = models.CharField(
        verbose_name=_("Pin Code"), default="431001", max_length=100
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"),
        max_length=250,
        default="Block Number , Street Name, City , State , Country - PIN",
    )
    ...
    tax = models.DecimalField(
        ...
        decimal_places=2,
        default=0.15,
        help_text="15% property tax is charged.",
    )
    ...
    photo1 = models.ImageField(
        verbose_name=_("Photo 1"), default="/interior_sample.jpg", null=True, blank=True
    )
    photo2 = models.ImageField(
        verbose_name=_("Photo 2"), default="/interior_sample.jpg", null=True, blank=True
    )
    photo3 = models.ImageField(
        verbose_name=_("Photo 3"), default="/interior_sample.jpg", null=True, blank=True
    )
    photo4 = models.ImageField(
        verbose_name=_("Photo 4"), default="/interior_sample.jpg", null=True, blank=True
    )
