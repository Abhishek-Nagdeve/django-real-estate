...
class GetProfileAPIView(APIView):
    ...
    def get(self, request):
        ...
        )  # what is this context and waht is the use if this is not done what will happen
...
class UpdateProfileAPIView(APIView):
    ...
    def patch(self, request, username):
        ...
        data = request.data
        serializer = UpdateProfileSerializer(instance=request.user.profile, data=data)
