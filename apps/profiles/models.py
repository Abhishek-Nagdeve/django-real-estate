...
class Profile(TimeStampedUUIDModel):
    ...
    profile_photo = models.ImageField(
        verbose_name=_("Profile Photo"), default="/profile_photo.png"
    )
    ...
    state = models.CharField(
        verbose_name=_("State"), default="Maharashtra", blank=False, null=False
    )
    city = models.CharField(
        verbose_name=_("City"), default="Aurangabad", blank=False, null=False
    )
    ...
    num_reviews = models.IntegerField(
        verbose_name=_("Number of Revies"), default=0, null=True, blank=True
    )
